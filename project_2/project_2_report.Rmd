...
# 4. Model diagnostics
to comment
```{r residuals diagnostics, echo=FALSE}
...
invisible(plot(roc(df$purchase,
               ...
               col = "red", 
               print.auc = F,
               main = "ROC curves: logistic model with all the initial variables (red) vs. logistic model with variable selection (blue) vs final logistic model (green)"))
invisible(plot(roc(df$purchase,
                   fitted(model)),
               print.auc = F, 
               col = "blue", 

...
## Method 2
### Shifting the curves 
In this method, I exchange the order of my steps. First, I want to have my curves 'at the same time' but I don't want to delete some values on the right due to the limit I have defined at the 1st of November 2020. I change the time scale to have all the time values represented in the interval [0,1] where 0 represents the beginning of the study (which in 'real' time differs for each country) and 1 the end of the study (fixed at the 1st of November 2020 which is the same for each country). 

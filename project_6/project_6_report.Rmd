...
#original data set too heavy, so I have exported a condensed one in my files following this procedure 
...
df <- read.csv('data_processed.csv', header = T) #data that is less big

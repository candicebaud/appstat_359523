...
# Interpretation 
The results of the principal component analysis (PCA) with method 1 reveal that the first principal component accounts for 77% of the total variance. This component exhibits an initial steep upward trend, capturing the first peak observed in the curves. Towards the end, it gradually decreases until it reaches zero. The second principal component explains 14% of the variance and shows an increasing trend following the decline of the first principal component. Moving on, the third and fourth principal components display a peak at the beginning, followed by a decrease. Together, they account for 9% of the explained variance. In total, the first four principal components explain 100% of the total variance observed in the data.


The second principal component analysis obtained with method 2 reveals that the first principal component also accounts for 77% of the total variance and is really close to what I had obtained with method 1. The second principal component analysis accounts now for 15% of the variance, whereas the third and fourth account for 7%. In total the first four PC account for 99% of the variance.

...
```{r, fig.align="center", fig.cap="Figure 3: Shifted and smoothed curves with method 1"}
...
### Smoothing
I don't have the same amount of observations for each country and I have not yet smoothed my data so I here use the B-splines to do so in this section. After smoothing, I obtain *Figure 4*.
...
```{r, fig.align="center", fig.cap="Figure 4: Shifted and smoothed curves with method 2"}
#pivot_longer(data_smoothed, cols = 'Albania', names_to = 'location')
to_plot <- data.frame(data_smoothed)
to_plot <- to_plot%>%
  pivot_longer(!time, names_to = "location", values_to = "total_cases_log_smoothed")
...
The second principal component analysis obtained with method 2 reveals that the first principal component also accounts for 80% of the total variance and is really close to what I had obtained with method 1. The second principal component analysis accounts now for 14% of the variance, whereas the third and fourth account for 4%. In total the first four PC account for 98% of the variance.

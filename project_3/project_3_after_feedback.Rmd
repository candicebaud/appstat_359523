...
The stability analyse shows that the model is not that robust since the coefficients are not significant in this one. Moreover, when looking at the residuals, as previously stated, some influential outliers were identified which can possibly slightly bias the models we built. As a deepening of this work, one could therefore refit the models without those outliers.
